    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-6">
      <section className="grid gap-6 border border-border/70 bg-[linear-gradient(135deg,rgba(16,185,129,0.12),transparent_35%),linear-gradient(180deg,rgba(255,255,255,0.02),transparent_22rem)] p-6">
        <pre className="overflow-x-auto font-mono text-[10px] leading-tight text-muted-foreground">
          DEMO APP 02 - TARGET APP
        </pre>
        <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-4">
            <p className="text-[11px] uppercase tracking-[0.35em] text-muted-foreground">
              FALCON CONNECT DEMO APP 02
            </p>
            ...
            <p className="max-w-3xl text-sm text-muted-foreground">
              The target app is responsible for receiving the connection request and displaying the
              consent screen. This demo application is a minimal blueprint for a target app that
              wants to integrate with a source app. It uses only the FALCON Connect SDK - to act
              like a real application as closely as possible.
            </p>
          </div>
        </div>
      </section>
