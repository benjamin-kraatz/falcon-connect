...
This is the server for the FALCON Connect service.
It is the place where the FALCON Connect infrastructure is implemented.
It is responsible for handling the requests from the FALCON Connect dashboard and the FALCON-supported applications, including registration, verification, authorization and basic information exchange (e.g. base URL for the endpoint to communicate with).
