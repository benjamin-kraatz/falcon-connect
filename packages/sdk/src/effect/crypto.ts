 ...
 */
export const verifyFalconAppRequestEffect = Effect.fn("verifyFalconAppRequestEffect")(function* (input: {
  appId: string;
  keyId: string;
  ...
  const canonical = yield* canonicalizeFalconAppRequest({
    ...
    Effect.mapError((cause) => new RequestPayloadCanonicalizationError({ input, cause })),
  );
  return yield* Effect.tryPromise({
    try: () =>
 ...
 */
export const signInstallIntentTokenEffect = Effect.fn("signInstallIntentTokenEffect")(function* (input: {
  privateJwk: SupportedJwk;
  keyId: string;
  issuer: string;
  audience: string;
 ...
 */
export const signConnectionAccessTokenEffect = Effect.fn("signConnectionAccessTokenEffect")(function* (input: {
  privateJwk: SupportedJwk;
  keyId: string;
  issuer: string;
  audience: string;
 ...
 */
export const getPublicJwkEffect = Effect.fn("getPublicJwkEffect")(function* (privateJwk: SupportedJwk) {
 ...
 */
export const verifyInstallIntentTokenEffect = Effect.fn("verifyInstallIntentTokenEffect")(function* (input: {
  token: string;
  issuer: string;
  audience: string;
  jwksUrl: string;
